...
def lunar_phase(tday):
    ...
    emojis = {
        ...
        'new':'&#127761;',
        'waxing_crescent':'&#127762',
        'first_quarter':'&#127763',
        'waxing_gibbous':'&#127764',
        'full':'&#127765',
        'waning_gibbous':'&#127766',
        'last_quarter':'&#127767',
        'waning_crescent':'&#127768'
    }
    ...
    if message == 'full':
        return f' | Moon Phase: The Moon is Full {output}'#\n\n{moon_details}' 
        ...
        return f' | Moon Phase:{word.title()} {output}'
